...
function handler() {
    ...
    this.SubmitQuery = function () {
        ...
        if ((object_choices != '...') && (object_choices.length == 1)) {
            ...
            secondDropDownMenu = RemoveSpecialChars(document.getElementById('objEnter2').value);
        ...
        new_name = nn + "," + secondDropDownMenu;
        old_name = new_name; // this is needed so you can send the server logs.
